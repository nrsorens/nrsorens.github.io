...
class Board {
  ...
  draw() {
    //const LstaticLeftArrow = new createjs.Bitmap("./assets/images/staticDown.png");
    ...
    //const LstaticRightArrow = new createjs.Bitmap("./assets/images/staticUp.png");

    //const RstaticLeftArrow = new createjs.Bitmap("./assets/images/staticDown.png");
    ...
    //const RstaticRightArrow = new createjs.Bitmap("./assets/images/staticUp.png");
    ...
    RstaticUpArrow.image.onload = () => (this.stage.update());

    this.stage.addChild(LstaticDownArrow, LstaticUpArrow,
      RstaticDownArrow, RstaticUpArrow);
...
class Game {
  constructor(stage) {
    ...
    this.music = new Audio('./assets/songs/TheKevinSong.mp3');
  ...
  play(difficulty) {
    ...
    switch(difficulty) {
      case "light":
        speed = document.getElementById("speeder").value;
        break;
      case "standard":
        speed = document.getElementById("speeder").value;
        break;
    ...
    */
    ...
    function randomGen() {
      ...
      switch(randArrow) {
        case 1: RcreateDownArrow();  break;
        case 2: RcreateDownArrow();  break;
        case 3: RcreateUpArrow();    break;
        case 4: RcreateUpArrow();    break;
        case 5: break;
        case 6: LcreateDownArrow();  break;
        case 7: LcreateDownArrow();  break;
        case 8: LcreateUpArrow();    break;
        case 9: LcreateUpArrow();    break;
        case 10: break;
      }
    }
  }
...
class LleftArrow {
  constructor() {
    let leftArrow = new createjs.Bitmap("./assets/images/lh_down.png");
    leftArrow.x = 25;
    leftArrow.y = 720;
    this.listener = "";
    return leftArrow;
...
class LrightArrow {
  constructor() {
    let rightArrow = new createjs.Bitmap("./assets/images/lh_up.png");
    rightArrow.x = 250;
    rightArrow.y = 720;
    this.listener = "";
    return rightArrow;
...
class LleftPressedArrow {
  constructor() {
    let leftPressed = new createjs.Bitmap("./assets/images/staticDownPressed.png");
    leftPressed.x = 22;
    leftPressed.y = 22;
...
class LrightPressedArrow {
  constructor() {
    let rightPressed = new createjs.Bitmap("./assets/images/staticUpPressed.png");
    rightPressed.x = 247;
    rightPressed.y = 22;
...
class RleftArrow {
  constructor() {
    let leftArrow = new createjs.Bitmap("./assets/images/rh_down.png");
    leftArrow.x = 400;
    leftArrow.y = 720;
    this.listener = "";
    return leftArrow;
...
class RrightArrow {
  constructor() {
    let rightArrow = new createjs.Bitmap("./assets/images/rh_up.png");
    rightArrow.x = 625;
    rightArrow.y = 720;
    this.listener = "";
    return rightArrow;
